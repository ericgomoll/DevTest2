...
namespace EligoCustomerPortal.Web
{
    public class Startup
    {
        ...
        {
            //Inject DBContext and Data services.
            services.AddDbContext<EligoDataContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DBConnection")));
